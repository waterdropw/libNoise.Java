...
public class RidgedMulti extends Module {
  ...
  public RidgedMulti(long cPtr, boolean cMemoryOwn) {
    super(NoiseModuleJNI.RidgedMulti_SWIGUpcast(cPtr), cMemoryOwn);
    swigCPtr = cPtr;
  }

  public static long getCPtr(RidgedMulti obj) {
  ...
  public NoiseQuality GetNoiseQuality() {
    return NoiseQuality.swigToEnum(NoiseModuleJNI.RidgedMulti_GetNoiseQuality(swigCPtr, this));
  }
  ...
  public void SetNoiseQuality(NoiseQuality noiseQuality) {
    NoiseModuleJNI.RidgedMulti_SetNoiseQuality(swigCPtr, this, noiseQuality.swigValue());
  }
